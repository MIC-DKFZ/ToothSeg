...
CODE_PATH=.
input_dir="..."   # data needs to be in a imagesTs folder in this directory
output_dir="..."
...
# Default
nnUNetv2_predict --continue_prediction --save_probabilities -i ${input_dir}/imagesTs -o ${output_dir}/semseg_branch -d 181 -tr nnUNetTrainer_onlyMirror01_DASegOrd0 -c 3d_fullres_resample_torch_256_bs8 -f all -nps 1
# or Parallelized
...
# Default
nnUNetv2_predict --continue_prediction -i ${input_dir}/imagesTs_resized_for_instanceseg_spacing_02_02_02 -o ${output_dir}/instseg_branch_border_core -d 188 -c 3d_fullres_resample_torch_192_bs8 -f all
# or Parallelized
